...
tcp_monitor_serializer = api.model('TcpMonitor', {
    ...
    'doc': fields.String(required=False, description='Doc', max_length=200, example='string'),
    'hostgroups': fields.String(required=False, description='Host Groups', max_length=200, example='string'),
    'notes': fields.String(required=False, description='Notes', max_length=200, example='string'),
    ...
    'notification_slack': fields.String(required=False, description='Notification Slack', max_length=200,
                                        example='string'),
    'zbx_proxy': fields.String(required=False, description='Zabix Proxy', max_length=200, example='string'),
})
